      ...
      <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
          <a href="#">
            <img
              ...
              src="https://images.unsplash.com/photo-1638913974023-cef988e81629?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwzMXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
            />
        ...
        <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
          <a href="#">
            <img
              className="hover:grow hover:shadow-lg"
              src="https://images.unsplash.com/photo-1648737966316-864c713a8356?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwyMXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
            />
            <div className="pt-3 flex items-center justify-between">
              <p className="">Product Name</p>
              <svg
        ...
        <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
          <a href="#">
            <img
              className="hover:grow hover:shadow-lg"
              src="https://images.unsplash.com/photo-1655925220123-13a7aa532cf0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw0Nnx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
            />
            <div className="pt-3 flex items-center justify-between">
              <p className="">Product Name</p>
              <svg
